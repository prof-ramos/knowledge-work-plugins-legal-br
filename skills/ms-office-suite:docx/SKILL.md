...
Edit files in `unpacked/word/`. **Use "Claude" as the author** for tracked changes and comments, unless the user explicitly requests a different name.
...
Use `comment.py` to handle boilerplate:
```bash
